...
export const ContactForm: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-4xl p-4 flex items-center justify-center">
            <div className="w-full bg-white rounded-lg shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-gray-100 max-w-4xl m-auto p-8 sm:p-8 text-left">
                    ...
                    >
                        ...
                        <div className="relative w-full">
                            <input
                                ...
                                className={`peer w-full border px-4 py-3.5 rounded-[6px] text-[14px] bg-white text-gray-700 font-[700] outline-none transition-all ${errors.fullName
        ...
        ${errors.fullName ? 'text-red-500' : 'text-gray-400 peer-focus:text-red-600'}`}
                            ...
                            {errors.fullName && <span className="text-xs text-red-500 mt-1.5 block px-1">{errors.fullName}</span>}
                        </div>
                        {/* Email Address */}
                        <div className="relative w-full">
                            <input
                                ...
                                onChange={handleChange}
                                className={`peer w-full border px-4 py-3.5 rounded-[6px] text-[14px] bg-white text-gray-700 font-normal outline-none transition-all ${errors.email
                                    ? 'border-red-500 focus:border-red-500'
                                    : 'border-gray-300 focus:border-red-600'
                                    }`}
                            />
                    ...
                    {/* Phone Input */}
                    <div className="relative w-full" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
                        <input
                            type="tel"
                            name="phone"
                            id="phone"
                    ...
                    <div className="relative w-full" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
                        <textarea
                            ...
                            onChange={handleChange}
                            className={`peer w-full border px-4 py-3.5 rounded-[6px] text-[14px] bg-white text-gray-700 font-normal outline-none transition-all resize-none ${errors.message
                                ? 'border-red-500 focus:border-red-500'
                                : 'border-gray-300 focus:border-red-600'
                                }`}
                        />
